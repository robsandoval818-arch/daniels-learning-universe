...
export default function MathChallengeScreen() {
  ...
  const handleAnswer = (correct: boolean) => {
    recordAnswer('math', skillId, correct, progress.currentDay)
  ...
  return (
    <ThemeBackground theme={theme}>
      <TopBar theme={theme} stars={progress.stars} streak={progress.streakDays} onBack={() => setScreen('mission-map')} title="Math Mission" />
